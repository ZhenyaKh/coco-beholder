...
'The script cleans two directories with data. The script deletes only pcap/json/jsonl/png/log files'
' and does not touch any subdirectories. If any of chosen data directories gets completely empty'
